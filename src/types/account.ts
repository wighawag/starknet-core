import { EDataAvailabilityMode, ETransactionVersion, ResourceBounds } from './api/index.js';
import {
  AllowArray,
  BigNumberish,
  BlockIdentifier,
...
import { DeclareTransactionReceiptResponse, EstimateFeeResponse } from './provider/index.js';
